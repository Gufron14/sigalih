<div>
    <div class="card card-primary card-outline">
        <div class="card-header">
            <div class="card-title">
                <div class="justify-content-between">
                    <h5 class="fw-bold">Pengajuan {{ $pengajuans->surat->nama_surat }} </h5>
        ...
        <div class="card-body">
            ...
            <a wire:click="downloadPDF" class="btn btn-success fw-bold">Terima
                Pengajuan</a>
            <a href="" class="btn btn-danger fw-bold">Tolak
                Pengajuan</a>
            <a href=""
