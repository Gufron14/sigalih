                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model="nama_surat" placeholder="contoh: Surat Keterangan Domisili" class="form-control @error('nama_surat') is-invalid @enderror">
                            @error('nama_surat')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model="singkatan" placeholder="contoh: SKD" class="form-control @error('singkatan') is-invalid @enderror">
                            @error('singkatan')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
