        ...
        <div data-pixr-simplebar>
            <div class="pb-6">
                ...
                <ul class="list-unstyled mb-6">
                    ...
                    {{-- <li class="menu-item">
                        <a class="d-flex align-items-center" href="{{ route('createSurat') }}">
                            <span class="menu-icon">
                    ...
                    <li class="menu-item"><a class="d-flex align-items-center" href="{{ route('pengajuan') }}">
                            <span class="menu-icon">
                            ...
                            <span class="menu-link">
                                ...
                                @php
                                    ...
                                    $pengajuan = RequestSurat::where('status', 'tunggu')->count();
                                @endphp
                                <span
                    ...
                    <!-- Pages Menu Section-->
                    <li class="menu-section mt-4">kelola warga</li>
                    <li class="menu-item">
                        <a class="d-flex align-items-center collapsed" href="{{ route('user') }}">
                            <span class="menu-icon">
                            ...
                            <span class="menu-link">User</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a class="d-flex align-items-center collapsed" href="{{ route('warga') }}">
                            <span class="menu-icon">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
                                    style="enable-background:new 0 0 512 512;" xml:space="preserve">
                            ...
                            <span class="menu-link">Data Warga</span>
                        </a>
                    </li>
                    <!-- / Pages Menu Section-->
