<div>
    @section('breadcrumbs')
        ...
        <li class="breadcrumb-item active">Edit Transparansi</li>
    @endsection
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <div class="mb-4">
                                ...
                                @enderror
                                <img src="{{ Storage::url($transparansi->infografik) }}" alt="{{ $transparansi->infografik }}" width="100px">
                            </div>
                        </div>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary fw-bold"><i class="fas fa-save me-2"></i> Simpan Perubahan</button>
            </form>
        </div>
    </div>
</div>
