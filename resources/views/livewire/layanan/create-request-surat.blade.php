<div class="container mx-auto">
    ...
    <div class="row ">
        ...
        <div class="col-md-6">
            @if ($statusPermohonan)
                {{-- @foreach ($request_surat as $request) --}}
                    {{-- @if ($request_surat->jenis_surat_id == $selectedLetterId) --}}
                        @if ($statusPermohonan === 'tunggu')
                            <div class="card border-warning rounded-4 mb-4">
                                <div class="card-body p-4 d-flex gap-4 align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="card-text">Permohonan {{ $jenisSurat->nama_surat }} Anda sedang dalam proses. Mohon tunggu informasi lebih lanjut.</p>
                                    </div>
                                </div>
                            </div>
                        @elseif ($statusPermohonan === 'terima')
                            
                            <div class="card border-success rounded-4  mb-4">
                                <div class="card-body d-flex p-4 gap-4 align-items-center">
                                    ...
                                    <div class="lh-sm">
                                        ...
                                        <small class="card-text">Permohonan {{ $jenisSurat->nama_surat }} Anda telah diterima.</small>
                                        <div class="mb-3">
                            ...
                            <div class="card border-warning rounded-4 shadow-sm mb-4">
                                <div class="card-body p-4 d-flex gap-4 align-items-center">
                                    ...
                                    <div class="lh-1">
                                        ...
                                        <p class="card-text">Permohonan {{ $jenisSurat->nama_surat }} Anda telah ditolak. Alasan: {{ $request->catatan_admin }}</p>
                                    </div>
                                </div>
                            </div>
                        @endif
