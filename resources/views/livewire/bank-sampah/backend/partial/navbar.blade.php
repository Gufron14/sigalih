    ...
    <div class="container-fluid">
        <a class="navbar-brand d-flex justify-content-start align-items-center border-end" href="./index.html">
            <div class="d-flex align-items-center">
                ...
                <span class="fw-black fs-6 lh-1 fw-bold fs-4">Bank Sampah</span>
            </div>
        </a>
        <div class="d-flex justify-content-between align-items-center flex-grow-1 navbar-actions">
            ...
            <div class="d-flex align-items-center">
                ...
                <!-- / Apps-->
                @livewire('bank-sampah.backend.auth.logout')

                <!-- Profile Menu-->
                <div class="dropdown ms-1">
                    <button class="btn btn-link p-0 position-relative" type="button" id="profileDropdown"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        @if (Auth::guard('bs-admin')->check() && Auth::guard('bs-admin')->user()->avatar)
                            <img src="{{ Auth::guard('bs-admin')->user()->avatar }}" alt="BS Admin Avatar">
                        @else
                            <img src="https://ui-avatars.com/api/?name={{ Auth::guard('bs-admin')->user()->username }}" class="img-thumbnail rounded-circle" alt="" width="40px">
                        @endif
                        {{-- <picture>
