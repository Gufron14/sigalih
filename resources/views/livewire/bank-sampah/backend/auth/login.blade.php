        ...
        <div class="card mx-auto w-75 shadow-sm border-0">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col p-5">
                        <img src="{{ asset('assets/img/garbage-recycle.svg') }}" alt="">
                    </div>
                    <div class="col p-5">
                        <div class="mb-5 text-center">
                            <h4 class="fw-bold text-success">Login Admin Bank Sampah</h4>
                        </div>
                        {{-- Form --}}
                        <form wire:submit.prevent="login" enctype="multipart/form-data">
                            ...
                            @endif
                            <div class="mb-3 mt-3">
                                <button type="submit" class="btn btn-success d-grid w-100 fw-bold">Masuk</button>
                            </div>
                        </form>
                        {{-- End Form --}}
                    </div>
