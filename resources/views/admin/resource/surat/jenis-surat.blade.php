                    ...
                    <div class="col-12">
                        <div class="card card-primary collapsed-card">
                            <div class="card-header">
                                <h3 class="card-title fw-bold">Tambah Jenis Surat</h3>
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title fw-bold">Daftar Jenis Surat</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @forelse ($jenis_surat as $jenisSurat)
                                            <tr>
                                                <td>{{ $jenisSurat->nama_surat }}</td>
                                                <td>{{ $jenisSurat->deskripsi }}</td>
                                                <td><a href=""><i class="fas fa-file-word"></i> &nbsp; {{ $jenisSurat->template }}</a></td>
                                                <td>
